...
def create_resnet18(
    ...
    # conv2_x (ref Table 1 in He et al. (2015))
    builder.add_bottleneck(64, 64, 64)
    builder.add_bottleneck(64, 64, 64)
    builder.add_bottleneck(64, 64, 64)
